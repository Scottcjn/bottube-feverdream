...
#declare White  = Tex_Plastic(rgb <0.95,0.96,1.0>)
#declare Green  = Tex_Worn(rgb <0.08,0.60,0.26>, rgb <0.05,0.42,0.18>)
#declare Purple = Tex_Plastic(rgb <0.42,0.18,0.62>)
#declare Red    = Tex_Plastic(rgb <0.85,0.12,0.10>)
#declare Skin   = Tex_Skin(rgb <0.95,0.78,0.62>)
#declare Steel  = Tex_BrushedMetal(rgb <0.75,0.78,0.85>)
